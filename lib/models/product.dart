...
//
//     final Products = postsFromJson(jsonString);
...
Products productDetailFromJson(String str) =>
    Products.fromJson(json.decode(str));

String productDetailToJson(Products data) => json.encode(data.toJson());
...
final downloadTypeValues = EnumValues({"standard": DownloadType.STANDARD});
